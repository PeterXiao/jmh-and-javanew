 ...
 * Name:luozix.start.pattern.lambdasGofPattern.examples.decorator Date:2021年3月4日下午6:03:14 Copyright
 * (c) 2021, xiaoyulong07@outlook.com All Rights Reserved.
 */
/**
 * @Title: DecoratorGof.java @Package
 * luozix.start.pattern.lambdasGofPattern.examples.decorator @Description: TODO(用一句话描述该文件做什么)
 *
 * @author xiao xiaoyulong07@outlook.com
 * @date 2021年3月4日 下午6:03:14
 * @version V1.0
 */
