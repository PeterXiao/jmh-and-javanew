 ...
 * Name:luozix.start.pattern.lambdasGofPattern.examples.template Date:2021年3月4日下午6:10:12 Copyright
 * (c) 2021, xiaoyulong07@outlook.com All Rights Reserved.
 */
/**
 * @Title: Resource.java @Package
 * luozix.start.pattern.lambdasGofPattern.examples.template @Description: TODO(用一句话描述该文件做什么)
 *
 * @author xiao xiaoyulong07@outlook.com
 * @date 2021年3月4日 下午6:10:12
 * @version V1.0
 */
