 ...
 * Name:luozix.start.pattern.lambdasGofPattern.examples.observer Date:2021年3月4日下午6:08:22 Copyright
 * (c) 2021, xiaoyulong07@outlook.com All Rights Reserved.
 */
/**
 * @Title: ObserverGof.java @Package
 * luozix.start.pattern.lambdasGofPattern.examples.observer @Description: TODO(用一句话描述该文件做什么)
 *
 * @author xiao xiaoyulong07@outlook.com
 * @date 2021年3月4日 下午6:08:22
 * @version V1.0
 */
package luozix.start.pattern.lambdasGofPattern.examples.observer;
/**
 * ClassName:ObserverGof <br>
 * Function: TODO ADD FUNCTION. <br>
 * Reason: TODO ADD REASON. <br>
 * Date: 2021年3月4日 下午6:08:22 <br>
 *
 * @author xiaoy
 * @version
 * @since JDK 1.8
