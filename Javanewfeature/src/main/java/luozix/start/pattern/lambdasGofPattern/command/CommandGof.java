 ...
 * Name:luozix.start.pattern.lambdasGofPattern.command Date:2021年3月4日下午5:42:32 Copyright (c) 2021,
 * xiaoyulong07@outlook.com All Rights Reserved.
 */
/**
 * @Title: CommandGof.java @Package luozix.start.pattern.lambdasGofPattern.command @Description:
 * TODO(用一句话描述该文件做什么)
 *
 * @author xiao xiaoyulong07@outlook.com
 * @date 2021年3月4日 下午5:42:32
 * @version V1.0
 */
