 ...
 * Name:luozix.start.pattern.lambdasGofPattern.examples.visitor Date:2021年3月4日下午6:11:45 Copyright
 * (c) 2021, xiaoyulong07@outlook.com All Rights Reserved.
 */
/**
 * @Title: VisitorLambda.java @Package
 * luozix.start.pattern.lambdasGofPattern.examples.visitor @Description: TODO(用一句话描述该文件做什么)
 *
 * @author xiao xiaoyulong07@outlook.com
 * @date 2021年3月4日 下午6:11:45
 * @version V1.0
 */
package luozix.start.pattern.lambdasGofPattern.examples.visitor;
/**
 * ClassName:VisitorLambda <br>
 * Function: TODO ADD FUNCTION. <br>
 * Reason: TODO ADD REASON. <br>
 * Date: 2021年3月4日 下午6:11:45 <br>
 *
 * @author xiaoy
 * @version
 * @since JDK 1.8
