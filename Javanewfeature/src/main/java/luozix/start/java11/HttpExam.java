	 ...
	 * File Name:HttpExam.java 
	 * Package Name:luozix.start.java11 
	 * Date:2021年3月2日下午6:35:00 
...
/**
 * ClassName:HttpExam <br>
 * Function: TODO ADD FUNCTION. <br>
 * Reason: TODO ADD REASON. <br>
 * Date: 2021年3月2日 下午6:35:00 <br>
 *
 * @author xiaoy
 * @version
 * @since JDK 1.8
...
/**
 * @ClassName: HttpExam @Description: TODO(这里用一句话描述这个类的作用)
 *
 * <p>* Java 11 的 Http Client 示例
 *
 * <p>移除了 HttpResponse.BodyHandler.asString()
 *
 * <p>使用 HttpResponse.BodyHandlers.ofString() 代替功能
 *
...
public class HttpExam {
  ...
  public static void downloadFile() throws Exception {
    ...
    HttpRequest request =
        HttpRequest.newBuilder().uri(new URI("https://labs.consol.de/")).GET().build();
  ...
  public static void proxy() throws Exception {
    ...
    HttpRequest request =
        HttpRequest.newBuilder().uri(new URI("https://www.google.com")).GET().build();
  ...
  public static void http2() throws Exception {
    HttpClient.newBuilder()
        ...
        .build()
        .sendAsync(
            HttpRequest.newBuilder().uri(new URI("https://http2.akamai.com/demo")).GET().build(),
  ...
  /**
   * @throws Exception @Title: main @Description: TODO(这里用一句话描述这个方法的作用)
   * @param @param args 设定文件
   * @return void 返回类型 date: 2021年3月2日 下午6:35:00.<br>
   * @author xiaoy
   * @param args
   * @since JDK 1.8
   * @throws
