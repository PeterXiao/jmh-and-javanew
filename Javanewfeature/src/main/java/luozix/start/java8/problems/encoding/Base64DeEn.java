/**
 * Project Name:java11_in_action File Name:Base64.java Package
 * Name:luozix.start.java8.problems.encoding Date:2021年2月28日下午6:16:34 Copyright (c) 2021,
 * xiaoyulong07@outlook.com All Rights Reserved.
 */
/**
 * @Title: Base64.java @Package luozix.start.java8.problems.encoding @Description:
 * TODO(用一句话描述该文件做什么)
 *
...
public class Base64DeEn {
   ...
   * @return void 返回类型 date: 2021年2月28日 下午6:16:34.<br>
   * @author xiaoy
   * @param args
   * @since JDK 1.8
   * @throws
