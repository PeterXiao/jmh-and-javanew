/**  
* @Title: LinkedListMergeSort.java
* @Package luozix.start.exams.alg
* @Description: TODO(用一句话描述该文件做什么)
* @author xiaoyu xiaoyulong07@outlook.com 
* @date 2021年2月4日 上午11:25:56
* @version V1.0  
*/
package luozix.start.exams.alg;

/**
 * @ClassName: LinkedListMergeSort
 * @Description: 链表排序, 建议使用归并排序， 问题描述，给定一个Int的链表，要求在时间最优的情况下完成链表元素由大到小的排序， e.g:
 *               1->5->4->3->2 排序后结果 5->4->3->2->1
 *
 * @author xiaoyu xiaoyulong07@outlook.com
 * @date 2021年2月4日 上午11:25:56
 *
	...
	* @throws
	...
	public Node mergeSort(Node first, int length) {
		...
		if (length == 1) {
			...
			/**
			 * 这里是链表归并时要注意的细节 在链表进行归并排序过程中，会涉及到将一个链表打散为两个独立的链表，所以需要在中间元素的位置将其后续指针指为null；
			 */
