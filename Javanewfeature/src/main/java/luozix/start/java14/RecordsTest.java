...
/**
 * This record has the same effect as PointPojo, but the getters has differents
 * name. Behide the scene a class which extends `java.lang.Record` is generated.
 * The parameters of a Record are called components.
 *
 * To see: Compile: `javac --enable-preview --source 14 RecordsTest.java` See
 * compiled class: `javap PointRecord.class`
 */
record PointRecord(int x, @Validatable(validate = true) int y) {
	...
	/**
	 * This is the canonical constructor declared by the compiler when using Record.
	 * It has the same parameters from record components.
	 */
	/*
	 * public PointRecord(int x, int y) { this.x = x; this.y = y; }
	 */

	/**
	 * We should use compact constructor to validate the state. This will be
	 * appended to the generated constructor with the parameters from the
	 * declaration.
	 */
	public PointRecord {
