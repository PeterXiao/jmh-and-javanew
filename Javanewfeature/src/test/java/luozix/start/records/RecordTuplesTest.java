	 ...
	 * File Name:RecordTuplesTest.java
	 * Package Name:luozix.start.records
	 * Date:2021年3月5日下午8:51:10
	 * Copyright (c) 2021, xiaoyulong07@outlook.com All Rights Reserved.
	 * 
	*/
	/**
* @Title: RecordTuplesTest.java
* @Package luozix.start.records
* @Description: TODO(用一句话描述该文件做什么)
* @author xiao xiaoyulong07@outlook.com
* @date 2021年3月5日 下午8:51:10
* @version V1.0
*/
	  
	package luozix.start.records;
	/**
	 * ClassName:RecordTuplesTest <br/>
	 * Function: TODO ADD FUNCTION. <br/>
	 * Reason:   TODO ADD REASON. <br/>
	 * Date:     2021年3月5日 下午8:51:10 <br/>
	 * @author   xiaoy
	 * @version
	 * @since    JDK 1.8
	 * @see
...
import static luozix.start.records.RecordTuplesTest.TriTuple.builder;
import static org.junit.Assert.assertEquals;

/**
* @ClassName: RecordTuplesTest
