...
public class Traits {
	 ...
	 * DOWNSIDES
	 *
	 * - requires considerable amount of boilerplate - has a non-trivial structure -
	 * delegating interface has less flexibility than a class - Object's methods can
	 * not be default-implemented, so toString, equals, hashCode, ... can never be
	 * forwarded to existing implementation
	 *
	 * ALTERNATIVES
	 *
	 * - extension type collecting all needed methods - utility methods
	 */
	public static void report(Megacorp megacorp) {
		...
		final var corp = (MegacorpDelegate & IsSuccessful & IsEvil) () -> megacorp;
		System.out.printf("Corporation %s is %s and %s.\n", corp.name(),
