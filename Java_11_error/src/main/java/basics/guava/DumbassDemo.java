...
public class DumbassDemo {
	...
	@Override
	public int compare(final TheWireCharacter a, final TheWireCharacter b) {
	    return a.seasons.size() - b.seasons.size();
	}
    };

    public static void main(final String... args) {
	final List<TheWireCharacter> characters = Arrays.asList(new TheWireCharacter("Jimmy McNulty", 1, 2, 3, 4, 5),
	...
	for (final TheWireCharacter c : characters) {
	    ...
	    // The problem with this approach isn't the actual code we have here, it's
	    // benign.
	    // Instead, what I've seen happen again and again, is that these manual
	    // iterations
	    // turn into a very complicated "main loop" into which feature after feature is
	    // shoehorned, until it's very hard to tell what is being done, and which part
	    // of
