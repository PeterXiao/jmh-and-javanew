...
public class DiamondOperatorExample {
    ...
    static abstract class AbstractMyHandler<T> {

        private T content;

        public AbstractMyHandler(T content) {
    ...
    public static void main(String[] args) {
        AbstractMyHandler<Integer> intHandler = new AbstractMyHandler<>(1) {
            @Override
            public void handle() {
        ...
        AbstractMyHandler<? extends Integer> intHandler1 = new AbstractMyHandler<>(10) {
            @Override
            void handle() {
                System.out.println("收到红包 > " + getContent() + "元");
            }
        ...
        AbstractMyHandler<?> handler = new AbstractMyHandler<>("魔法师") {
            @Override
            void handle() {
