...
//    }
    ...
    public void pushAll(final Iterable<? extends E> src) {
	for (final E e : src) {
	    push(e);
	}
    }
...
//    }
    ...
    public void popAll(final Collection<? super E> dst) {
	while (!isEmpty()) {
	    dst.add(pop());
	}
    }
	...
	final Iterable<Integer> integers = Arrays.asList(3, 1, 4, 1, 5, 9);
