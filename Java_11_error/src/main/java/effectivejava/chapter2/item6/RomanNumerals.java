...
public class RomanNumerals {
    ...
    static boolean isRomanNumeralSlow(final String s) {
    ...
    static boolean isRomanNumeralFast(final String s) {
	return ROMAN.matcher(s).matches();
    }

    public static void main(final String[] args) {
	final int numSets = Integer.parseInt(args[0]);
	final int numReps = Integer.parseInt(args[1]);
	boolean b = false;
