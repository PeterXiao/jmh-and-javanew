  ...
  * 
  * contributed by James McIlree ByteString code thanks to Matthieu Bentot and The Anh Tran
  */
 ...
 public class knucleotide {
     static ArrayList<Callable<Map<ByteString, ByteString>>> createFragmentTasks(final byte[] sequence,
         int[] fragmentLengths) {
         ArrayList<Callable<Map<ByteString, ByteString>>> tasks =
             new ArrayList<Callable<Map<ByteString, ByteString>>>();
