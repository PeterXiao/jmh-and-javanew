 ...
 public class revcomp {
     ...
     public static void main(String[] args) throws Exception {
         try (Strand strand = new Strand(); FileInputStream standIn = new FileInputStream(FileDescriptor.in);
         ...
         for (int t = 0; t < NCPU; t++) {
             ...
             Callable<Void> task = () -> {
                 for (int i = start; i < end; i++) {
                     ...
                     int endIndex =
                         leftEndChunkIndex == leftChunkIndex ? realLeftEndIndex : chunks.get(leftChunkIndex).length - 1;
