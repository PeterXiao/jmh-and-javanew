  ...
  * 
  * contributed by James McIlree modified by Tagir Valeev
  */
 ...
 public class knucleotide {
     ...
     /**
      * Get the long key for given byte array of codes at given offset and length (length must be less than 32)
      */
     ...
     /**
      * Convert given byte array (limiting to given length) containing acgtACGT to codes (0 = A, 1 = C, 2 = G, 3 = T)
