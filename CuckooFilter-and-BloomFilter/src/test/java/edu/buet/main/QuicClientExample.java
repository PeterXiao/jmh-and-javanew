  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ChannelHandler codec = new QuicClientCodecBuilder().sslContext(context)
          ...
          // As we don't want to support remote initiated streams just setup the limit for local
          // initiated
      ...
      QuicChannel quicChannel =
          QuicChannel.newBootstrap(channel).streamHandler(new ChannelInboundHandlerAdapter() {
            @Override
            public void channelActive(ChannelHandlerContext ctx) {
              // As we did not allow any remote initiated streams we will never see this method
              // called.
