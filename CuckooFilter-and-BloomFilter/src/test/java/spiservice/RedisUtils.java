/**
 * Project Name:CuckooFilter-vs-BloomFilter File Name:RedisUtils.java Package Name:spiservice
 * Date:2021年5月3日下午7:24:22 Copyright (c) 2021, xiaoyulong07@outlook.com All Rights Reserved.
 */
/**
 * @Title: RedisUtils.java @Package spiservice @Description: TODO(用一句话描述该文件做什么)
 *
 * @author xiao xiaoyulong07@outlook.com
 * @date 2021年5月3日 下午7:24:22
 * @version V1.0
 */
package spiservice;
	/**
...
/**
 * @ClassName: RedisUtils @Description: TODO(这里用一句话描述这个类的作用)
 *
...
//
//	    @Autowired
//	    private RedisTemplate<String, Object> MyRedisTemplate;  // 这里注入自己写的自定义的模板
//
//	    // =============================common============================
//	    /**
//	     * 指定缓存失效时间
