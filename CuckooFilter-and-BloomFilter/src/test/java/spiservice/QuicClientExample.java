/**
 * Project Name:CuckooFilter-vs-BloomFilter File Name:QuicClientExample.java Package Name:spiservice
 * Date:2021年6月13日下午7:37:39 Copyright (c) 2021, xiaoyulong07@outlook.com All Rights Reserved.
 */
/**
 * @Title: QuicClientExample.java @Package spiservice @Description: TODO(用一句话描述该文件做什么)
 *
 * @author xiao xiaoyulong07@outlook.com
 * @date 2021年6月13日 下午7:37:39
 * @version V1.0
 */
package spiservice;

/**
 * @ClassName: QuicClientExample @Description: TODO(这里用一句话描述这个类的作用)
 *
...
//                      // method called.
//                      // That said just let us keep it here to demonstrate that this handle would
// be
//                      // called
...
//              .sync()
//              .getNow();
//      // Write the data and send the FIN. After this its not possible anymore to write any more
//      // data.
//      streamChannel
//          .writeAndFlush(Unpooled.copiedBuffer("GET /\r\n", CharsetUtil.US_ASCII))
