...
import java.util.List;
 ...
 public class TestTimSort {
      ...
      * These conditions guarantee that TimSort merges all x_j's one by one (resulting in X) using only merges on the
      ...
      * The Y_i's are chosen to satisfy the invariant throughout execution, but the x_{i,j}'s are merged (by
      * <code>TimSort.mergeCollapse</code>) into an X_i that violates the invariant.
      * 
      * @param X
      *            The sum of all run lengths that will be added to <code>runs</code>.
      */
