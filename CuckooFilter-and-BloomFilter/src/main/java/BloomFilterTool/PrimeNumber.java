...
public class PrimeNumber {
    ...
    public static void main(String[] args) {
        // 获得一个4位数的随机大素数
        /*
         * long longVar4 = createRadomPrimeNunber(4); System.out.println(longVar4);
         * //获得一个5位数的随机大素数 long longVar5 = createRadomPrimeNunber(5);
         */
        System.out.println(listPartPrimeNumber(5, 1));
    }
